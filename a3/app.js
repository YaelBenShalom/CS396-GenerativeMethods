...
window.addEventListener("load", function() {
	...
	document.getElementById("background").value = HSLToHex(...tool.background)
	document.getElementById("color").value = HSLToHex(...tool.color)
	...
	let mainP5 = new p5(
        ...
        if (tool.mode == 'clear'){
			...
			p.mouseDragged = () => {
				...
				fxn(p, tool.size, tool.background, tool.color)
        // loop();
			}
