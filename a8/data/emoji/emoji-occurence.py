...
counter = 0
for i in range(len(emojiOccurrenceData)):
    counter += emojiOccurrenceData[i]['Occurrences']

print("MaxOccurrences: ", emojiOccurrenceData[0]['Occurrences'])
print("TotOccurrences: ", counter)
print("NumOfOccurrences: ", len(emojiOccurrenceData))
